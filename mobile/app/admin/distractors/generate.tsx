  ...
  return (
    <View style={styles.root}>
      <View style={styles.card}>
        <Text style={styles.title}>Distractor generation</Text>
        <Text style={styles.body}>
          Bulk AI-cached distractor generation, gated by the distractor-validation pipeline before reaching gameplay.
        </Text>
